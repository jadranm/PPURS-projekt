...
// #define LCD_RW_PORT			PORTX
// #define LCD_RW_PIN			PORTXn		//don't need this pin since we only write to LCD

#define LCD_LINES				2			//number of LCD vertical lines
#define LCD_DISP_LENGTH			16    		//number of LCD horizontal lines

#define LCD_RS_PORT				PORTB     	//RS pin port
#define LCD_RS_PIN				PORTB5      //RS bit, connect to RS pin on LCD

#define LCD_E_PORT				PORTB     	//E pin port
#define LCD_E_PIN				PORTB4		//E pin bit, connect to E pin on LCD

#define LCD_DATA0_PORT			PORTB		//D0 pin port
#define LCD_DATA0_PIN			PORTB3      //D0 pin bit, connect to D4 pin on LCD

#define LCD_DATA1_PORT			PORTB		//D1 pin port
#define LCD_DATA1_PIN			PORTB2      //D1 pin bit, connect to D5 pin on LCD

#define LCD_DATA2_PORT			PORTB     	//D2 pin port
#define LCD_DATA2_PIN			PORTB1      //D2 pin bit, connect to D6 pin on LCD

#define LCD_DATA3_PORT			PORTB     	//D3 pin port
#define LCD_DATA3_PIN			PORTB0      //D3 pin bit, connect to D7 pin on LCD
...
//added because printing float numbers doesn't work with %f in lcd_print()
